<%@ Page Title="" Language="C#" MasterPageFile="~/General.Master" AutoEventWireup="true" CodeBehind="Mosdot.aspx.cs" Inherits="hachsharanetweb.Mosdot" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>הכשרה.נט - הוספת מוסד</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">

     <h1 class="page-head">יצירת מוסד</h1>
    <div class="container">
<div class="row">
<div class="col-md-9 ">
